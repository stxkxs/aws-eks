...
describe('Configuration Schema Validation', () => {
  ...
  describe('Environment validation', () => {
    ...
    test('getConfig returns correct environment config', () => {
      const devConfig = getConfig('dev', testAccountId, testRegion, TEST_EXTERNAL_VALUES);
      expect(devConfig.environment).toBe('dev');

      const stagingConfig = getConfig('staging', testAccountId, testRegion, TEST_EXTERNAL_VALUES);
      expect(stagingConfig.environment).toBe('staging');

      const prodConfig = getConfig('production', testAccountId, testRegion, TEST_EXTERNAL_VALUES);
  ...
  describe('Dev configuration', () => {
    ...
    beforeEach(() => {
      config = getDevConfig(testAccountId, testRegion, TEST_EXTERNAL_VALUES);
    });
  ...
  describe('Staging configuration', () => {
    ...
    beforeEach(() => {
      config = getStagingConfig(testAccountId, testRegion, TEST_EXTERNAL_VALUES);
    });
  ...
  describe('Production configuration', () => {
    ...
    beforeEach(() => {
      config = getProductionConfig(testAccountId, testRegion, TEST_EXTERNAL_VALUES);
    });
  ...
  describe('Configuration consistency', () => {
    const configs = [
      { name: 'dev', config: getDevConfig(testAccountId, testRegion, TEST_EXTERNAL_VALUES) },
      { name: 'staging', config: getStagingConfig(testAccountId, testRegion, TEST_EXTERNAL_VALUES) },
      { name: 'production', config: getProductionConfig(testAccountId, testRegion, TEST_EXTERNAL_VALUES) },
    ];
  ...
  describe('Security configuration validation', () => {
    test.each([
      ['dev', getDevConfig(testAccountId, testRegion, TEST_EXTERNAL_VALUES)],
      ['staging', getStagingConfig(testAccountId, testRegion, TEST_EXTERNAL_VALUES)],
      ['production', getProductionConfig(testAccountId, testRegion, TEST_EXTERNAL_VALUES)],
    ...
    test('production has stricter severity threshold', () => {
      const prodConfig = getProductionConfig(testAccountId, testRegion, TEST_EXTERNAL_VALUES);
  ...
  describe('ArgoCD SSO configuration', () => {
    ...
    test('staging has SSO disabled', () => {
      const config = getStagingConfig(testAccountId, testRegion, TEST_EXTERNAL_VALUES);
