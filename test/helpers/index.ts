...
/**
 * Test fixture for external values (org-specific settings).
 * Uses fake values so tests don't depend on real infrastructure.
 */
export const TEST_EXTERNAL_VALUES: ExternalValues = {
  hostedZoneId: 'Z0000000000TESTZONE',
  domainName: 'test.example.com',
  adminRoleArn: 'arn:aws:iam::123456789012:role/TestAdminRole',
  gitOpsRepoUrl: 'https://github.com/test-org/test-gitops.git',
  githubOrg: 'test-org',
};
...
export function getTestConfig(
  ...
  externalValues: ExternalValues = TEST_EXTERNAL_VALUES,
): EnvironmentConfig {
  switch (environment) {
    case 'dev':
