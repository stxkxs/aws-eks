...
usage() {
  ...
  echo ""
  echo "Example:"
  echo "  $0 --secret-name dev-argocd-github-oauth --client-id Iv1.abc123 --client-secret abc123secret --profile stxkxs"
  exit 1
}
...
echo "     npx cdk deploy --all -c environment=dev --profile stxkxs"
